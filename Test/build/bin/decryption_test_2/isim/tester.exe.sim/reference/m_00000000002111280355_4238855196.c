...
#endif
static const char *ng0 = "F:/facultate/Anul III sem I/Arhitectura Calculatoarelor - REZOLVAT/tema 2/tema2_task3_checker/build/bin/reference/ref_decryption_regfile.v";
static int ng1[] = {0, 0};
